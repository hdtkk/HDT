...
#         for key in kwargs['stage1_package'].keys():
#             new_key = 'stage1_' + key
# #            print(key)
#             new_stage1_dict[new_key] = kwargs['stage1_package'][key]
#         trained_net.load_state_dict(new_stage1_dict, strict=False)
#         trained_net.load_state_dict(kwargs['stage_package'], strict=False)
        ########### final_state ###########
        trained_net.load_state_dict(kwargs['final_package'], strict=True)
        ...
        # used for training stage not inference
        self.trainer(
            net=trained_net,
    ...
    def train(
        ...
        **kwargs,
        ...
        return self.train_model(
            ...
            shuffle_buffer_length=shuffle_buffer_length,
            cache_data=cache_data,
            final_package=kwargs['stage2_dict']
        ).trained_net
