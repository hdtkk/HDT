...
class CompressionEmbedding(nn.Module):
    def __init__(self, d_model):
        ...
        # self.network_1 = nn.Sequential(
        #     nn.Conv1d(
        #         in_channels=self.past_embed, out_channels=64, kernel_size=4, stride=2, padding=1
        #     ),
        #     nn.Tanh(),
        #     nn.Dropout(p=0.1),
        #     nn.LayerNorm(normalized_shape=[64, self.history_length // 2]),
        # )
        #
        # self.network_2 = nn.Sequential(
        #     nn.Conv1d(
        ...
        #     nn.Tanh(),
        #     nn.Dropout(p=0.1),
        #     nn.LayerNorm(normalized_shape=[128, self.history_length // 4]),
        # )
        #
        # self.network_3 = nn.Sequential(
        #     nn.Conv1d(
        ...
        #     nn.Tanh(),
        #     nn.Dropout(p=0.1),
        #     nn.LayerNorm(normalized_shape=[256, self.history_length // 8]),
        # )
        # self.pred_network = nn.Sequential(
        #     nn.Conv1d(
        #         in_channels=256, out_channels=d_model, kernel_size=3, stride=1, padding=1
        #     ),
        #     nn.Tanh(),
        # )
    ...
    def forward(self, x):
        ...
        # x_2 = self.network_2(x_1)
        # x_3 = self.network_3(x_2)
        # out = self.pred_network(x_3)
...
class TokenEmbedding(nn.Module):
    def __init__(self, d_model):
        ...
        #         in_channels=c_in, out_channels=1, kernel_size=3, stride=1, padding=1
        #     ),
        #     nn.ReLU(),
        #     nn.Dropout(p=0.1),
        #     nn.Conv1d(
        #         in_channels=1, out_channels=1, kernel_size=3, stride=1, padding=1
        #     )) for _ in range(self.past_embed)
        # ])
...
class Past_transformer(nn.Module):
    ...
    def forward(self, x_dec, x_enc,
        ...
        # if self.output_attention:
        #     return enc_out[:, -(self.pred_len + 1):, :], None
        # else:
        #     return enc_out[:, -(self.pred_len + 1):, :]  # [B, L, D]
