...
# first fetch dataset needs regenerate=True
...
# trained_net = estimator.train(dataset_train, num_workers=0, vqvae_dict=state_dict)
trained_net = estimator.train(dataset_train, num_workers=0)
torch.save(trained_net.state_dict(), './Taxi_96_stage1.pkl')
