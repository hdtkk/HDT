...
stage2_downsampled_state_dict = torch.load('./Taxi_downsampled96_stage2.pkl', map_location='cpu')
...
trained_net = estimator.train(dataset_train, num_workers=0, stage2_dict=stage2_downsampled_state_dict)
torch.save(trained_net.state_dict(), './Taxi_96_final_state.pkl')
